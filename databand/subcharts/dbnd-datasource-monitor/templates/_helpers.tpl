...
*/}}
{{- define "dbnd-datasource-monitor.name" -}}
...
*/}}
{{- define "dbnd-datasource-monitor.fullname" -}}
...
{{- define "dbnd-datasource-monitor.cmdrun" -}}
{{- if .Values.newrelic.enabled -}}
{{ printf  "newrelic-admin run-program dbnd-datasource-monitor" }}
{{- else -}}
{{ printf  "dbnd-datasource-monitor" }}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "dbnd-datasource-monitor.mapenvsecrets" }}
