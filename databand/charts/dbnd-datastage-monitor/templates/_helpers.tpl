...
*/}}
{{- define "dbnd-datastage-monitor.name" -}}
...
*/}}
{{- define "dbnd-datastage-monitor.fullname" -}}
...
{{- define "dbnd-datastage-monitor.cmdrun" -}}

{{ printf  "dbnd-datastage-monitor" }}
{{- end -}}
...
*/}}
{{- define "dbnd-datastage-monitor.mapenvsecrets" }}
